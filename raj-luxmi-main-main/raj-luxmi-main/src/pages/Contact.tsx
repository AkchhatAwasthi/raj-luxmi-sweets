        ...
        <Card>
          ...
          <CardContent>
            <div className="aspect-video rounded-lg overflow-hidden relative group">
              <a
                href="https://maps.app.goo.gl/MEe21M4ian74JKCF6"
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full h-full"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-primary/5 flex items-center justify-center hover:from-primary/20 hover:to-primary/10 transition-all duration-300">
                  <div className="text-center space-y-4">
                    <MapPin className="h-16 w-16 mx-auto text-primary" />
                    <div>
                      <p className="text-xl font-semibold mb-2">View Our Location on Google Maps</p>
