      ...
      <div className="container mx-auto px-4 pt-20 pb-10 relative z-10">
        <div className="text-center mb-16">
          <div className="inline-block mb-4">
            <div className="border py-1 px-4 rounded-full text-sm font-instrument font-normal bg-white/80 shadow-sm backdrop-blur-sm">
              Our Journey
            </div>
          </div>

          <h2 className="text-2xl md:text-3xl lg:text-4xl tracking-tight mb-6 font-instrument font-normal">
                    ...
                    >
                      ...
                      <CardContent className="relative p-6 flex flex-col flex-grow">
                        ...
                        <div className="text-center mt-2 flex-grow flex flex-col justify-center">
                          <h3 className="text-2xl mb-3 text-gray-800 drop-shadow-sm font-instrument font-normal">
                            {item.title}
                          </h3>
