  ...
  const fetchFestivalProducts = async () => {
    try {
      ...
      if (productIds.length > 0) {
        ...
        setFestivalProducts(sortedProducts);
        setLoading(false);
        return;
      }
    ...
    <section className="py-12 md:py-16 bg-[#F9F3EA] relative overflow-hidden">
      ...
      <div className="max-w-[1600px] mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-8 gap-4 border-b border-[#E6D5B8] pb-4 relative">
          <div>
            <span className="text-[10px] uppercase tracking-[0.25em] text-[#9B4E4E] mb-2 block font-medium">SEASONAL DELIGHTS</span>
        ...
        <div className="relative">
          {loading ? (
            ...
            <div className="text-center py-20 border border-[#E6D5B8]/20 p-8">
              ...
              <h3 className="text-xl font-instrument font-normal text-[#2C1810] mb-2">No festival specials</h3>
        ...
        <div className="text-center mt-12">
          <button
            onClick={() => router.push('/products?category=Festival')}
