    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-[hsl(25_95%_90%)] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <div className="inline-flex items-center bg-gradient-to-r from-primary/10 to-[hsl(0_84%_60%)/10] backdrop-blur-sm border border-primary/20 text-destructive px-6 py-3 rounded-full text-sm font-instrument font-normal shadow-lg mb-6">
            <CheckCircle className="w-4 h-4 mr-2" />
            Why Choose Us
          </div>

          <h2 className="text-xl md:text-2xl lg:text-3xl text-gray-900 mb-6 font-instrument font-normal">
            Why{' '}
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-instrument font-normal">
            ...
            >
              <div className="bg-white rounded-3xl p-8 text-center shadow-sm hover:shadow-2xl transition-all duration-300 border border-gray-100 group-hover:border-gray-200 relative overflow-hidden h-full">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors font-instrument font-normal">
                    {feature.description}
                  </p>
                </div>
        ...
        >
          <div className="bg-gradient-to-br from-white via-gray-50 to-[hsl(25_95%_90%)] rounded-3xl p-8 md:p-16 shadow-xl border border-gray-100 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center bg-gradient-to-r from-primary/10 to-[hsl(0_84%_60%)/10] backdrop-blur-sm border border-primary/20 text-destructive px-6 py-3 rounded-full text-sm font-instrument font-normal shadow-lg mb-8">
                <Users className="w-4 h-4 mr-2" />
                Join 10,000+ Happy Sweet Lovers
              </div>

              <h3 className="text-2xl md:text-3xl text-gray-900 mb-6 font-instrument font-normal">
                Ready to Indulge in Raj Luxmi?
              </h3>

              <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed font-instrument font-normal">
